<template lang="pug">
    div
        Anchor(title="Icon 图标")
        Anchor(title="概述")
        p UI 图标使用开源项目 
            a(href="https://fa5.dashgame.com/#/%E5%9B%BE%E6%A0%87" ) Awesome Icons
        div.api
...
export default class IconDoc extends Vue {
